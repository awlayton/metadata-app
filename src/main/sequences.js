...
export const setSurveyPage = [set(state`pageNum`, props`pageNum`)]
...
export const uploadScreenshot = [actions.uploadScreenshot]
...
// Runs _after_ logout
export const logout = [set(state`loggedin`, false), set(state`pastData`, [])]
